...
public class DepeFood {
    ...
    public static String handleBuatPesanan(String namaRestoran, String tanggalPemesanan, List<String> listMenuPesananRequest) throws Exception {
    ...
    public static void handleBayarBill(String orderId, String paymentOption) throws Exception {
        while (true) {
